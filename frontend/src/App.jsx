  ...
  return (
    ...
    >
      <div style={{
        ...
        right: 0,
        height: '4px',
        background: `linear-gradient(to right, ${modeColors[route.mode]}, ${modeColors[route.mode]})`
      }} />
      ...
      <div style={{ padding: '16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', fontSize: '14px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#64748b' }}>
            ...
            <span style={{ fontWeight: '500' }}>{route.predicted_duration_min} min</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#64748b' }}>
            <Leaf size={14} style={{ color: '#22c55e' }} />
            <span style={{ fontWeight: '500' }}>{(route.emission_g / 1000).toFixed(2)} kg</span>
          </div>
        </div>
        ...
        <button 
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.backgroundColor = isSelected ? '#3b82f6' : '#f1f5f9';
          }}
        >
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '14px', fontWeight: '500', color: '#334155' }}>Priority:</span>
  ...
  onMouseLeave={(e) => {
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
      ...
      <div style={{ flex: 1 }}>
        ...
        {trend && (
          <div style={{ fontSize: '12px', color: '#22c55e', fontWeight: '500', marginTop: '4px' }}>
            ↑ {trend}
          </div>
        )}
      </div>
...
const Dashboard = ({ cityStats }) => {
  ...
  const avgEmission = stats.total_emission_g / Math.max(stats.route_count, 1) / 1000;
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '12px', color: '#64748b', marginTop: '4px' }}>CO₂ per route</div>
      </div>
    </div>
  );
};
          ...
          <div>
            ...
            {routes.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '48px 0', color: '#94a3b8' }}>
                <Navigation size={48} style={{ margin: '0 auto 12px', opacity: 0.3 }} />
